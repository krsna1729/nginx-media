...
| Capacity | `fanout_delay` percentiles (p50/p95/p99/p99.9) reported with their conditions, a receiver storm measured against a 700 ms failover SLA, and `bench-burst-sizing`'s real-media TS capacity sweep |
